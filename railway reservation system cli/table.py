def Create_Database_Railway():
    ...
    mycon=mysql.connector.connect(host='localhost 3007',user='root',password='root')    
    cursor=mycon.cursor()
...
def table_creation_railway():
    import mysql.connector
    mycon=mysql.connector.connect(host='localhost 3007',user='root',password='root',database='railway')
    cursor=mycon.cursor()
    mycon.autocommit=True
